    ...
    """
        ...
        Returns:
            ref_list : list of strings
                each item in the list is a string corresponding to a single entry in the .bib file
    """
...
def readEntry(bib_entry):
    """
    Reads the .bib entry and returns a dictionary for the entries
    ...
    Returns:
        fields : dictionary
            keys in the dictionary are the field types and the corresponding
